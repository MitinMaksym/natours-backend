...
var showAlert = function showAlert(type, text) {
  hideAlert();
  var html = "<div class=\"alert alert--".concat(type, "\">").concat(text, "</div>");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('http://127.0.0.1:3003/api/v1/users/login', {
              email: email,
              password: password
            }, {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _axios.default.get('http://127.0.0.1:3003/api/v1/users/logout', {
              withCredentials: true
            });
...
var showMap = function showMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibWFrczk2IiwiYSI6ImNrc2l3eXZqcjA3bmEyd3FveGdkY2Y3MjEifQ.i97LYOFssVHEZg5sChka9A';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/maks96/cksiy9izy386h17s3woyjm444',
    scrollZoom: false // center: ['36.232845', '49.988358'],
    // zoom: 10,
    // interactive: false,
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).setLngLat(loc.coordinates).addTo(map); // Extend map bounds
